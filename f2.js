function Submit(){
 ...
 var cname = document.form.comp_name.value,
 
	fname = document.form.f_name.value,
  ...
  if(cname=="")
	{
		document.form.comp_name.focus() ;

  document.getElementById("errorBox").innerHTML = "Enter the company name";
