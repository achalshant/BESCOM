...
$sql="INSERT INTO cust_user (username,password,dom_id)
VALUES
('$_POST[username]','$_POST[password]','$_POST[dom_id]')";
...
if (!mysql_query($sql,$connection))
 ...
 $sql="INSERT INTO dom_meter (meter_no,dom_id,area)
VALUES
('$_POST[meter_no]','$_POST[dom_id]','$_POST[area]')"; 
if (!mysql_query($sql,$connection))
  {
  die('Error: ' . mysql_error());
  }
