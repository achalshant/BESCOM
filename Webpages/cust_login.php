...
<h1 style="text-align:center">Customer Login </h1><br/><br/>
...
?>
  <div>
    <div>
     <form style="text-align:center" action="connect2.php" method="post">
  ...
  <TD><a href="http://localhost/emp_login.php?id=0" style="float:right;">Employee? Click here.</a></TD>
</div>
