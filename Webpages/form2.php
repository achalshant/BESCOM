...
<div id="container">
  ...
  <div id="container_body">
    ...
    <div>
      ...
      <h2 class="form_title">New Customer Registration</h2>

      <p class="head_para">Commercial User</p>
	...
	<div id="form_name">
      ...
      <div class="firstnameorlastname">
       ...
       <form name="form" action="insert2.php" onsubmit="return Submit()" method="post" >
	   <script src="f2.js"></script>

       <div id="errorBox"></div>
	   
	   Name of the company
	   <input type="text" name="comp_name" value="" placeholder="Company Name"  class="input_name" ><br/><br/>
	   
	   Representative details<br/><br/>
	  ...
	  ID Proof &nbsp; &nbsp;
		...
		<h3 id="mid">Address of the company-</h3><p> <br/>
...
<!--
  ...
  <!--  <div id="form_name">
      ...
      <!--birthday details start
	  <input type="text" name="phno" value=""  placeholder="Your Phone Number" class="input_email"><br/><br/>
      ...
      <div>
		...
		<input type="text" name="birthday_day" size="2" maxlength="2" placeholder="DD"class="birthday_title"/>
		...
		<input type="text" name="birthday_year" size="4" maxlength="4" placeholder="YYYY"class="birthday_title"/> <br/><br/></p>
        <!--select name="birthday_year">
	  ...
	  ID Proof &nbsp; &nbsp;
			<select>
				<option value="" selected>Select ID Proof</option><option value="s1">Passport</option>
				<option value="s2">Adhaar Card</option><option value="s3">Voter ID</option>
				<option value="s4">PAN Card</option>
			</select>
			<input type="text" name="uid" size="17" maxlength="15" class="input_email"/>	<br/><br/>
		...
		<h3 id="mid">Address of the company-</h3><p> <br/>
			...
			PIN Code&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			<input type="text" name="pin" size="30" class="input_email"/> <br/><br/></p>
