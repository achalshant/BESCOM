    ...
    <li>
       Staff</a>
        <ul>
			...
			<li><a href="/view_staff_records.php?id=1">View Staff Records</a></li>
			<li><a href="/manage_staff_records.php?id=1">Manage Staff Records</a></li>
        </ul>
    </li>
...
<form name="form" action="/modify_customer_records.php?id=3" method="post" >
...
$dom_id=$_POST['dom_id'];
$sql = "DELETE FROM domusers WHERE  ";
$result = $conn->query($sql);
